<head>
    ...
    <link href="{{asset('cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.6.4/sweetalert2.css')}}" rel="stylesheet" type="text/css">
    ...
    <link href="{{asset('cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/2.1.25/daterangepicker.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css" rel="stylesheet')}}" type="text/css">
    <link href="{{asset('cdnjs.cloudflare.com/ajax/libs/jqvmap/1.5.1/jqvmap.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick-theme.min.css')}}" rel="stylesheet" type="text/css">
